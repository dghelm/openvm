...
pub mod bitwise_op_lookup {
    #[cfg(test)]
    use openvm_hip_common::d_buffer::DeviceBufferView;
    ...
    pub unsafe fn tracegen(
        ...
        HipError::from_result_i32(_bitwise_op_lookup_tracegen(
    ...
    pub unsafe fn dummy_tracegen(
        ...
        HipError::from_result_i32(_bitwise_dummy_tracegen(
            d_trace.as_mut_ptr(),
            records.view(),
...
pub mod range_tuple {
    ...
    pub unsafe fn tracegen(
        ...
        HipError::from_result_i32(_range_tuple_checker_tracegen(
            d_count.as_ptr() as *const u32,
            d_cpu_count
                .as_ref()
                .map(|b| b.as_ptr())
    ...
    pub unsafe fn dummy_tracegen(
        ...
        HipError::from_result_i32(_range_tuple_dummy_tracegen(
            d_data.as_ptr(),
            d_trace.as_mut_ptr(),
...
pub mod var_range {
    ...
    pub unsafe fn tracegen(
        ...
        HipError::from_result_i32(_range_checker_tracegen(
            d_count.as_ptr() as *const u32,
            d_cpu_count
                .as_ref()
                .map(|b| b.as_ptr())
    ...
    pub unsafe fn dummy_tracegen(
        ...
        HipError::from_result_i32(_var_range_dummy_tracegen(
            d_data.as_ptr(),
            d_trace.as_mut_ptr(),
            d_rc_count.as_mut_ptr() as *mut u32,
            d_data.len(),
...
pub mod encoder {
    ...
    pub unsafe fn dummy_tracegen(
        ...
        HipError::from_result_i32(_encoder_tracegen(
            d_trace.as_mut_ptr(),
            num_flags,
            max_degree,
            reserve_invalid,
...
pub mod is_equal {
    ...
    pub unsafe fn dummy_tracegen(
        ...
        HipError::from_result_i32(_isequal_tracegen(
            d_output.as_mut_ptr(),
    ...
    pub unsafe fn dummy_tracegen_array(
        ...
        HipError::from_result_i32(_isequal_array_tracegen(
            d_output.as_mut_ptr(),
            d_inputs_x.as_mut_ptr(),
            d_inputs_y.as_mut_ptr(),
            array_len as u32,
...
pub mod is_zero {
    ...
    pub unsafe fn dummy_tracegen(
        ...
        HipError::from_result_i32(_iszero_tracegen(
            d_output.as_mut_ptr(),
            d_inputs.as_mut_ptr(),
            d_inputs.len() as u32,
        ))
...
pub mod less_than {
    ...
    pub unsafe fn assert_less_than_dummy_tracegen(
        ...
        HipError::from_result_i32(_assert_less_than_tracegen(
            trace.as_mut_ptr(),
            trace_height,
            pairs.as_ptr(),
            max_bits as u32,
    ...
    pub unsafe fn less_than_dummy_tracegen(
        ...
        HipError::from_result_i32(_less_than_tracegen(
            trace.as_mut_ptr(),
            trace_height,
            pairs.as_ptr(),
            max_bits as u32,
    ...
    pub unsafe fn less_than_array_dummy_tracegen(
        ...
        HipError::from_result_i32(_less_than_array_tracegen(
            trace.as_mut_ptr(),
            trace_height,
            pairs.as_ptr(),
            max_bits as u32,
