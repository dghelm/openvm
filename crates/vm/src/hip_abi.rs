...
use openvm_hip_backend::prelude::F;
use openvm_hip_common::{
    d_buffer::{DeviceBuffer, DeviceBufferView},
    error::HipError,
};

// These are FFI-compatible data structures shared between CUDA and HIP
...
pub mod boundary {
    ...
    pub unsafe fn persistent_boundary_tracegen(
        ...
        HipError::from_result_i32(_persistent_boundary_tracegen(
            d_trace.as_mut_ptr(),
            height,
            width,
    ...
    pub unsafe fn volatile_boundary_tracegen(
        ...
        HipError::from_result_i32(_volatile_boundary_tracegen(
            d_trace.as_mut_ptr(),
            height,
            width,
            d_records.as_ptr(),
...
pub mod phantom {
    ...
    pub unsafe fn tracegen(
        ...
        HipError::from_result_i32(_phantom_tracegen(
            d_trace.as_mut_ptr(),
            height,
            width,
            d_records.view(),
...
pub mod poseidon2 {
    ...
    pub unsafe fn tracegen(
        ...
        HipError::from_result_i32(_system_poseidon2_tracegen(
            d_trace.as_mut_ptr(),
            height,
            width,
    ...
    pub unsafe fn deduplicate_records_get_temp_bytes(
        ...
        HipError::from_result_i32(_system_poseidon2_deduplicate_records_get_temp_bytes(
            d_records.as_mut_ptr(),
            d_counts.as_mut_ptr(),
            num_records,
    ...
    pub unsafe fn deduplicate_records(
        ...
        HipError::from_result_i32(_system_poseidon2_deduplicate_records(
            d_records.as_mut_ptr(),
            d_counts.as_mut_ptr(),
            num_records,
            d_num_records.as_mut_ptr(),
...
pub mod program {
    ...
    pub unsafe fn cached_tracegen<T>(
        ...
        HipError::from_result_i32(_program_cached_tracegen(
            d_trace.as_mut_ptr(),
            height,
            width,
            d_records.view(),
...
pub mod public_values {
    ...
    pub unsafe fn tracegen(
        ...
        HipError::from_result_i32(_public_values_tracegen(
            d_trace.as_mut_ptr(),
            height,
            width,
            d_records.view(),
...
pub mod access_adapters {
    ...
    pub unsafe fn tracegen(
        ...
        HipError::from_result_i32(_access_adapters_tracegen(
            d_trace_ptrs.as_ptr(),
            NUM_ADAPTERS,
...
mod testing {
    ...
    pub mod execution_testing {
        ...
        pub unsafe fn tracegen(
            ...
            HipError::from_result_i32(_execution_testing_tracegen(
                d_trace.as_mut_ptr(),
                height,
                width,
                d_records.view(),
    ...
    pub mod memory_testing {
        ...
        pub unsafe fn tracegen(
            ...
            HipError::from_result_i32(_memory_testing_tracegen(
                d_trace.as_mut_ptr(),
                height,
                width,
                d_records.as_ptr(),
    ...
    pub mod program_testing {
        ...
        pub unsafe fn tracegen(
            ...
            assert!(height.is_power_of_two());
            assert!(height >= num_records);
            HipError::from_result_i32(_program_testing_tracegen(
                d_trace.as_mut_ptr(),
                height,
                width,
                d_records.as_ptr(),
