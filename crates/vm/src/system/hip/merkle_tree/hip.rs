...
use openvm_hip_backend::{base::DeviceMatrix, types::F};
use openvm_hip_common::{copy::MemCopyH2D, d_buffer::DeviceBuffer, error::HipError, hipStream_t};
...
pub mod merkle_tree {
    ...
    pub unsafe fn build_merkle_subtree<T>(
        ...
        HipError::from_result_i32(_build_merkle_subtree(
            d_data.as_mut_ptr(),
            size,
    ...
    pub unsafe fn restore_merkle_subtree_path<T>(
        ...
        HipError::from_result_i32(_restore_merkle_subtree_path(
    ...
    pub unsafe fn calculate_zero_hash<T>(
        ...
        HipError::from_result_i32(_calculate_zero_hash(d_zero_hash.as_mut_raw_ptr(), size))
    }
    ...
    pub unsafe fn finalize_merkle_tree<T>(
        ...
        HipError::from_result_i32(_finalize_merkle_tree(
            d_roots.as_mut_ptr(),
    ...
    pub unsafe fn update_merkle_tree<T>(
        ...
        HipError::from_result_i32(_update_merkle_tree(
            num_leaves,
