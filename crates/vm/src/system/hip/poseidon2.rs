...
pub struct Poseidon2ChipHIP<const SBOX_REGISTERS: usize> {
...
impl<const SBOX_REGISTERS: usize> Poseidon2ChipHIP<SBOX_REGISTERS> {
...
impl<RA, const SBOX_REGISTERS: usize> Chip<RA, HipBackend> for Poseidon2ChipHIP<SBOX_REGISTERS> {
...
pub enum Poseidon2PeripheryChipHIP {
    Register0(Poseidon2ChipHIP<0>),
    Register1(Poseidon2ChipHIP<1>),
}

impl Poseidon2PeripheryChipHIP {
    pub fn new(max_buffer_size: usize, sbox_registers: usize) -> Self {
        match sbox_registers {
            0 => Self::Register0(Poseidon2ChipHIP::new(max_buffer_size)),
            1 => Self::Register1(Poseidon2ChipHIP::new(max_buffer_size)),
...
impl<RA> Chip<RA, HipBackend> for Poseidon2PeripheryChipHIP {
    fn generate_proving_ctx(&self, _: RA) -> AirProvingContext<HipBackend> {
        match self {
