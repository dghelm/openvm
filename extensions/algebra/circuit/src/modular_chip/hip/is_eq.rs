...
use openvm_circuit_primitives::{
    bigint::utils::big_uint_to_limbs, bitwise_op_lookup::BitwiseOperationLookupChipHIP,
...
use super::hip_abi::is_eq_hip::tracegen as modular_is_equal_tracegen;
use crate::modular_chip::{ModularIsEqualCoreCols, ModularIsEqualRecord};

#[derive(new)]
pub struct ModularIsEqualChipHip<
...
impl<const NUM_LANES: usize, const LANE_SIZE: usize, const TOTAL_LIMBS: usize>
    ...
    for ModularIsEqualChipHip<NUM_LANES, LANE_SIZE, TOTAL_LIMBS>
{
