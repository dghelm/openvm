...
pub mod alu256 {
    ...
    pub unsafe fn tracegen(
        ...
        HipError::from_result_i32(_alu256_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod beq256 {
    ...
    pub unsafe fn tracegen(
        ...
        assert!(height.is_power_of_two() || height == 0);
        HipError::from_result_i32(_branch_equal256_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod lt256 {
    ...
    pub unsafe fn tracegen(
        ...
        assert!(height.is_power_of_two() || height == 0);
        HipError::from_result_i32(_less_than256_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod blt256 {
    ...
    pub unsafe fn tracegen(
        ...
        assert!(height.is_power_of_two() || height == 0);
        HipError::from_result_i32(_branch_less_than256_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod shift256 {
    ...
    pub unsafe fn tracegen(
        ...
        assert!(height.is_power_of_two() || height == 0);
        HipError::from_result_i32(_shift256_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
...
pub mod mul256 {
    use openvm_hip_backend::chip::UInt2;
    ...
    pub unsafe fn tracegen(
        ...
        assert!(height.is_power_of_two() || height == 0);
        HipError::from_result_i32(_multiplication256_tracegen(
            d_trace.as_mut_ptr(),
            height,
            d_trace.len() / height,
            d_records.view(),
