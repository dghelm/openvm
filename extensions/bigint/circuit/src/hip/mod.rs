...
use openvm_circuit_primitives::{
    bitwise_op_lookup::BitwiseOperationLookupChipHIP, range_tuple::RangeTupleCheckerChipHIP,
    var_range::VariableRangeCheckerChipHIP,
};
...
impl Chip<DenseRecordArena, HipBackend> for BaseAlu256ChipHip {
...
#[derive(new)]
pub struct BranchEqual256ChipHip {
    pub range_checker: Arc<VariableRangeCheckerChipHIP>,
    pub bitwise_lookup: Arc<BitwiseOperationLookupChipHIP<RV32_CELL_BITS>>,
    pub pointer_max_bits: usize,
    pub timestamp_max_bits: usize,
...
impl Chip<DenseRecordArena, HipBackend> for BranchEqual256ChipHip {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<HipBackend> {
...
impl Chip<DenseRecordArena, HipBackend> for LessThan256ChipHip {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<HipBackend> {
...
#[derive(new)]
pub struct BranchLessThan256ChipHip {
    pub range_checker: Arc<VariableRangeCheckerChipHIP>,
    pub bitwise_lookup: Arc<BitwiseOperationLookupChipHIP<RV32_CELL_BITS>>,
    pub pointer_max_bits: usize,
    pub timestamp_max_bits: usize,
...
impl Chip<DenseRecordArena, HipBackend> for BranchLessThan256ChipHip {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<HipBackend> {
        const RECORD_SIZE: usize =
...
impl Chip<DenseRecordArena, HipBackend> for Shift256ChipHip {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<HipBackend> {
...
#[derive(new)]
pub struct Multiplication256ChipHip {
    pub range_checker: Arc<VariableRangeCheckerChipHIP>,
    pub bitwise_lookup: Arc<BitwiseOperationLookupChipHIP<RV32_CELL_BITS>>,
    pub range_tuple_checker: Arc<RangeTupleCheckerChipHIP<2>>,
    pub pointer_max_bits: usize,
    pub timestamp_max_bits: usize,
}

impl Chip<DenseRecordArena, HipBackend> for Multiplication256ChipHip {
    fn generate_proving_ctx(&self, arena: DenseRecordArena) -> AirProvingContext<HipBackend> {
        const RECORD_SIZE: usize =
