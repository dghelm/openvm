...
use openvm_circuit_primitives::{
    bitwise_op_lookup::BitwiseOperationLookupChipHIP, utils::next_power_of_two_or_zero,
...
use hip_abi::keccak256::*;

#[derive(new)]
pub struct Keccak256ChipHip {
...
impl Chip<DenseRecordArena, HipBackend> for Keccak256ChipHip {
