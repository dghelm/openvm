...
use crate::{
    ...
    hip_abi::field_arithmetic_hip,
};

#[derive(new)]
pub struct FieldArithmeticChipHip {
    pub range_checker: Arc<VariableRangeCheckerChipHIP>,
    pub timestamp_max_bits: usize,
}

impl Chip<DenseRecordArena, HipBackend> for FieldArithmeticChipHip {
