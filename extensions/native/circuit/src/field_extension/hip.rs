...
use super::{FieldExtensionCoreCols, FieldExtensionRecord, EXT_DEG};
use crate::{
    adapters::{NativeVectorizedAdapterCols, NativeVectorizedAdapterRecord},
    hip_abi::field_extension_hip,
};

#[derive(new)]
pub struct FieldExtensionChipHip {
    pub range_checker: Arc<VariableRangeCheckerChipHIP>,
    pub timestamp_max_bits: usize,
}

impl Chip<DenseRecordArena, HipBackend> for FieldExtensionChipHip {
