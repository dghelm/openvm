...
use crate::hip_abi::poseidon2_hip;

#[derive(new)]
pub struct NativePoseidon2ChipHip<const SBOX_REGISTERS: usize> {
    pub range_checker: Arc<VariableRangeCheckerChipHIP>,
    pub timestamp_max_bits: usize,
}

impl<const SBOX_REGISTERS: usize> Chip<DenseRecordArena, HipBackend>
    for NativePoseidon2ChipHip<SBOX_REGISTERS>
{
