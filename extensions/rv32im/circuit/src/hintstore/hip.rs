...
use crate::{
    hip_abi::hintstore_hip::{tracegen, OffsetInfo},
    Rv32HintStoreCols, Rv32HintStoreLayout, Rv32HintStoreRecordMut,
};

#[derive(new)]
pub struct Rv32HintStoreChipHip {
...
impl Chip<DenseRecordArena, HipBackend> for Rv32HintStoreChipHip {
        ...
        while offset < records.len() {
            ...
            for idx in 0..record.inner.num_words {
                offsets.push(OffsetInfo {
                    record_offset: prev_offset as u32,
                    local_idx: idx,
                });
            }
        }
