...
pub struct Sha256HipProverExt;

impl VmProverExtension<HipBabyBearPoseidon2Engine, DenseRecordArena, Sha256>
    for Sha256HipProverExt
{
    fn extend_prover(
        &self,
        _: &Sha256,
        ...
        let sha256 = Sha256VmChipHip::new(
            range_checker.clone(),
            bitwise_lu,
